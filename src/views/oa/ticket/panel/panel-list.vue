    ...
    <el-card shadow="never" class='d2-card-mini'>
        <template slot="header" >
            <div style='display: flex; align-items: center;'>
                ...
                <span>待处理的工单列表</span>
                <el-link type="primary" style='display: flex; flex: 1; justify-content: flex-end;' :underline="false" @click="gotoTicketTodoPage">查看更多</el-link>
            </div>
        </template>
        <el-table
            :data="tableData"
...
export default {
    ...
    methods: {
        ...
        gotoTicketTodoPage() {
            this.$router.push({name: 'oa-ticket-todo', params: {from: 'oa-ticket-panel'}})
        }
    }
}
</script>
