            ...
            <template slot="footer">
                <div class="btn-group">
                    <span
                        ...
                        @click="$open('https://github.com/d2-projects')"
                    >
                        开源组织
                    </span>
                    |
                    <span
                        class="btn-group__btn"
                        @click="$open('https://doc.d2admin.fairyever.com/zh/')"
                    >
                        文档
                    </span>
                    |
                    ...
                    <span
                        ...
                        @click="
                            $open(
                                'https://alibaba.github.io/ice/scaffold?type=vue'
                            )
                        "
                    >
                        飞冰
                    ...
                    <span
                        class="btn-group__btn"
                        @click="$open('https://daily.fairyever.com')"
                    >
                        日报
                    </span>
                    |
                    <el-popover :width="172" trigger="hover">
                        ...
                        >
                            官方公众号，主要推送前端技术类文章、框架资源、学习教程，以及
                            D2 系列项目更新信息
                        </p>
                    </el-popover>
                </div>
