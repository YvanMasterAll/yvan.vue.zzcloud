<template>
    <d2-container class="page">
        ...
        <el-button
            size="small"
            type="primary"
            @click="$log.capsule('title', 'primary')"
        >
        ...
        <el-button
            size="small"
            type="success"
            @click="$log.capsule('title', 'success', 'success')"
        >
        ...
        <el-button
            size="small"
            type="warning"
            @click="$log.capsule('title', 'warning', 'warning')"
        >
        ...
        <el-button
            size="small"
            type="danger"
            @click="$log.capsule('title', 'danger', 'danger')"
        >
        ...
        <el-button
            size="small"
            type="primary"
            @click="$log.primary('primary style')"
        >
        ...
        <el-button
            size="small"
            type="success"
            @click="$log.success('success style')"
        >
        ...
        <el-button
            size="small"
            type="warning"
            @click="$log.warning('warning style')"
        >
        ...
        <el-button
            size="small"
            type="danger"
            @click="$log.danger('danger style')"
        >
            $log.danger('danger style')
        </el-button>
        <p>效果 ( Chrome )</p>
        <img class="page__image-demo" src="./image/demo.png" />
    </d2-container>
</template>
