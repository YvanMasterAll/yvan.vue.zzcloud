    ...
    <d2-container>
        ...
        <el-row :gutter="10">
            <el-col :span="6">
                <el-card shadow="never" class="d2-card">
                    <template slot="header"
                        >PingFang SC</template
                    >
                    <p class="basic-typography-text typography-style-1">
                        和畅惠风
                    </p>
                </el-card>
            </el-col>
            <el-col :span="6">
                <el-card shadow="never" class="d2-card">
                    <template slot="header"
                        >Hiragino Sans GB</template
                    >
                    <p class="basic-typography-text typography-style-2">
                        和畅惠风
                    </p>
                </el-card>
            </el-col>
            <el-col :span="6">
                <el-card shadow="never" class="d2-card">
                    <template slot="header"
                        >Microsoft YaHei</template
                    >
                    <p class="basic-typography-text typography-style-3">
                        和畅惠风
                    </p>
                </el-card>
            </el-col>
