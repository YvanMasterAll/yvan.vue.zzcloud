...
const format = (function() {
        ...
        function Parser() {
            ...
            this.get_tag = function() {
                ...
                if (
                    ...
                    if (
                        this.Utils.in_array(tag_check, this.Utils.extra_liners)
                    ) {
    ...
    return function(data) {
        ...
        data = data.replace(new RegExp(dataHolder + '[0-9]+', 'g'), function(
            $0
        ) {
