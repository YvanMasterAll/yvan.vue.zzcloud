                ...
                >
                    <transition-group>
                        ...
                        >
                            <el-checkbox
                                flex-box="1"
                                v-model="currentValue[index].show"
                            >
...
export default {
    ...
    computed: {
        ...
        isIndeterminate() {
            ...
            let result =
                this.showLength > 0 && optionsLength !== this.showLength
            return result
        }
    },
    watch: {
    ...
    methods: {
        ...
        refresh() {
            ...
            if (
                currentValueOld.length > 0 &&
                currentValueOld.length === options.length
            ) {
