    ...
    children: (pre => [
            ...
            children: [
                {
                    ...
                    children: [
                        {
                            path: `${pre}container/full`,
                            title: '基础',
                            icon: ''
                        },
                        {
                            path: `${pre}container/full-slot`,
                            title: '插槽',
                            icon: ''
                        },
                        {
                            path: `${pre}container/full-bs`,
                            title: '滚动优化',
                            icon: ''
                        }
                    ]
                },
                {
                    ...
                    children: [
                        {
                            path: `${pre}container/ghost`,
                            title: '基础',
                            icon: ''
                        },
                        {
                            path: `${pre}container/ghost-slot`,
                            title: '插槽',
                            icon: ''
                        },
                        {
                            path: `${pre}container/ghost-bs`,
                            title: '滚动优化',
                            icon: ''
                        }
                    ]
                },
                {
                    ...
                    children: [
                        {
                            path: `${pre}container/card`,
                            title: '基础',
                            icon: ''
                        },
                        {
                            path: `${pre}container/card-slot`,
                            title: '插槽',
                            icon: ''
                        },
                        {
                            path: `${pre}container/card-bs`,
                            title: '滚动优化',
                            icon: ''
                        }
                    ]
                },
                {
                    ...
                    children: [
                        {
                            path: `${pre}container/api?bs=false`,
                            title: '滚动控制',
                            icon: ''
                        },
                        {
                            path: `${pre}container/api?bs=true`,
                            title: '滚动控制 BS',
                            icon: ''
                        }
                    ]
        ...
        },
        {
            ...
            children: [
                ...
                {
                    path: `${pre}contextmenu/custom-trigger`,
                    title: '自定义事件'
                }
            ]
        },
